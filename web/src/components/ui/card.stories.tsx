...
import { Calendar, Clock, Users, Shield, FileText, Heart } from 'lucide-react';
...
export const Default: Story = {
  render: () => (
    <Card className="w-[350px]">
      ...
      <CardContent>
        <p>Choose from our selection of document templates to get started quickly.</p>
      </CardContent>
      <CardFooter>
    ...
    <Card className="w-[350px] cursor-pointer transition-all hover:shadow-lg">
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground">
          Complete package including will creation, guardianship setup, and emergency access management.
        </p>
      </CardContent>
      <CardFooter>
