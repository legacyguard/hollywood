...
export const MilestoneCelebration: React.FC<MilestoneCelebrationProps> = ({
  ...
  const [celebrationStage, setCelebrationStage] = useState<'celebration' | 'impact' | 'rewards'>('celebration');
  ...
  const renderRewardsStage = () => (
    ...
    >
      <div className="text-center">
        <h3 className="text-xl font-bold text-gray-900 mb-2">Rewards Unlocked</h3>
        <p className="text-gray-600">Your dedication has earned you these benefits</p>
      </div>
      ...
      <div className="grid gap-4">
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-900">Protection Level</p>
        ...
        {/* Features Unlocked */}
        {milestone.rewards.features && milestone.rewards.features.length > 0 && (
          <Card>
            <CardContent className="p-4">
      ...
      <div className="space-y-3">
        {milestone.progress.nextAction && (
          <Button
            onClick={() => onContinue?.(milestone.progress.nextAction, milestone.progress.nextActionUrl)}
            className="w-full"
            size="lg"
          >
            {milestone.progress.nextAction}
