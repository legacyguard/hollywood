...
const texts: TextConfig = {
  ...
  sofia_welcome: {
    ...
    pragmatic:
      "Hello! I'm Sofia, your digital assistant for LegacyGuard. I can help you organize documents, manage guardians, and complete your legacy planning tasks efficiently. What would you like to accomplish?",
  },
