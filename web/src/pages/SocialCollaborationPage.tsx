                ...
                <CardContent className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">All family members active</p>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">5 new documents shared</p>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">Emergency protocol updated</p>
                      <p className="text-xs text-muted-foreground">Review new emergency access settings</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure emergency protocols and trusted contacts for critical situations
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium">Inactivity Trigger</span>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">Accessible Documents</CardTitle>
