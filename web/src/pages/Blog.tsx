...
const Blog = () => {
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Learn advanced strategies for protecting your family's future, including emergency access protocols and guardian selection.",
    ...
    },
    {
      ...
      excerpt: "Navigate the complexities of digital assets, social media accounts, and online presence in your estate planning.",
  ...
  const categories = [
    { name: "Estate Planning", count: 1, color: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300" },
    { name: "Family Security", count: 1, color: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300" },
    { name: "Digital Assets", count: 1, color: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300" },
    { name: "Legal Documents", count: 0, color: "bg-slate-100 text-slate-800 dark:bg-slate-900/30 dark:text-slate-300" }
  ];
                    ...
                    <div className="grid md:grid-cols-2 gap-0">
                      ...
                      <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 flex items-center justify-center">
                        <div className="text-center text-white">
                          <Icon name="file-text" className="h-24 w-24 mx-auto mb-4 opacity-80" />
                          <p className="text-lg font-semibold">Expert Legal Guidance</p>
                          <p className="text-blue-100">Professional insights for your family's future</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
