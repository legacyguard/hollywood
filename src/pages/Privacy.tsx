        ...
        >
          ...
          <Card className="p-8 bg-white/80 dark:bg-slate-800/80">
            <CardContent className="prose dark:prose-invert max-w-none">
              ...
              <p>
                At LegacyGuard, we understand that your personal and family information is incredibly sensitive. 
              ...
              <ul>
                ...
                <li><strong>Document Data:</strong> Files and documents you upload (encrypted on your device)</li>
              ...
              <p>
                LegacyGuard uses end-to-end encryption with a zero-knowledge architecture. This means:
              </p>
              <ul>
                <li>Your documents are encrypted on your device before being uploaded</li>
                <li>We cannot read, access, or decrypt your personal documents</li>
                <li>Only you have the keys to decrypt your information</li>
                <li>Even if compelled by law enforcement, we cannot provide your decrypted data</li>
              </ul>
              ...
              <h2>Contact Us</h2>
              <p>
                If you have any questions about this Privacy Policy, please contact us at privacy@legacyguard.com
              </p>
            </CardContent>
          </Card>
        </motion.div>
