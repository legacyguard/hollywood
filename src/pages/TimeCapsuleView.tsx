        ...
        <FadeIn duration={0.6}>
          ...
          <div className='text-center mb-8'>
            <div className='w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4'>
              <Icon name={"heart" as any} className='w-10 h-10 text-white' />
            </div>
            ...
            <div className='flex items-center justify-center gap-4 mt-4 text-sm text-gray-500'>
              <div className='flex items-center gap-1'>
                <Icon name={"calendar" as any} className='w-4 h-4' />
                <span>
              ...
              <div className='flex items-center gap-1'>
                <Icon name={"clock" as any} className='w-4 h-4' />
                <span>
                    ...
                    >
                      <div className='absolute inset-0 flex items-center justify-center'>
                        {!hasStarted && (
                          ...
                          >
                            <Icon name={"play" as any} className='w-8 h-8' />
                          </Button>
                        )}
                      </div>
                      ...
                      <div className='absolute bottom-0 left-0 right-0 p-4'>
                        <div className='flex items-center gap-3 text-white'>
                          ...
                          <Button
                            ...
                            className='text-white hover:bg-white/20'
                          >
                            <Icon name={"maximize" as any} className='w-4 h-4' />
                          </Button>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className='bg-gradient-to-br from-purple-600 to-pink-600 p-12'>
                    <div className='text-center text-white'>
                      <div className='w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6'>
                        <Icon name={"headphones" as any} className='w-12 h-12' />
                      </div>
            ...
            <Card className='mt-6'>
              <CardHeader>
                <CardTitle className='flex items-center gap-2'>
                  <Icon name={"message-square" as any} className='w-5 h-5' />
                  Message
                </CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className='text-center mt-8 p-6 bg-white/50 rounded-lg'>
            ...
            <div className='flex items-center justify-center gap-2 mt-2 text-xs text-gray-500'>
              <Icon name={"shield" as any} className='w-3 h-3' />
