                ...
                <div>
                  <div className='flex items-center gap-3 mb-3'>
                    <div className='w-12 h-12 bg-gradient-to-br from-purple-100 to-pink-100 rounded-full flex items-center justify-center'>
                      <Icon name={"heart" as any} className='w-6 h-6 text-purple-600' />
                    </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8'>
              ...
              <Card className='p-4'>
                <div className='flex items-center justify-between'>
                  ...
                  <Icon name={"calendar" as any} className='w-5 h-5 text-blue-600' />
                </div>
              </Card>
              ...
              <Card className='p-4'>
                <div className='flex items-center justify-between'>
                  ...
                  <Icon name={"shield" as any} className='w-5 h-5 text-purple-600' />
                </div>
              </Card>
            ...
            <FadeIn duration={0.5} delay={0.6}>
              <Card className='p-12 text-center'>
                <div className='w-20 h-20 bg-gradient-to-br from-purple-100 to-pink-100 rounded-full mx-auto mb-6 flex items-center justify-center'>
                  <Icon name={"heart" as any} className='w-10 h-10 text-purple-600' />
                </div>
                ...
                <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                  ...
                  <Button variant={"outline" as any} size='lg'>
                    <Icon name={"play-circle" as any} className='w-5 h-5 mr-2' />
                    Watch Demo
                  </Button>
                </div>
              </Card>
