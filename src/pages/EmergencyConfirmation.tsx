        ...
        <Card className="p-8 max-w-lg text-center">
          <div className="mb-6">
            ...
            <h1 className="text-2xl font-bold mb-2">
              {isConfirmed ? 'Emergency Activation Confirmed' : 'Emergency Activation Rejected'}
            </h1>
          ...
          <div className="space-y-4 mb-6">
              ...
              {isConfirmed ? (
                <ul className="text-sm text-muted-foreground space-y-2 text-left">
                  <li className="flex items-start gap-2">
                    <Icon name="check" className="w-4 h-4 mt-0.5 text-green-600" />
                    <span>Family members can now access emergency resources</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon name="check" className="w-4 h-4 mt-0.5 text-green-600" />
                    <span>Time capsules scheduled for emergency delivery are available</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon name="check" className="w-4 h-4 mt-0.5 text-green-600" />
                    <span>Other guardians have been notified of the activation</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon name="check" className="w-4 h-4 mt-0.5 text-green-600" />
                ...
                <ul className="text-sm text-muted-foreground space-y-2 text-left">
                  <li className="flex items-start gap-2">
                    <Icon name="info" className="w-4 h-4 mt-0.5 text-amber-600" />
                    <span>The system will continue monitoring for emergency conditions</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon name="info" className="w-4 h-4 mt-0.5 text-amber-600" />
                    <span>Other guardians may still respond to this activation</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon name="info" className="w-4 h-4 mt-0.5 text-amber-600" />
            ...
            <div className="text-xs text-muted-foreground">
              <p>
                <strong>Activation Type:</strong> {activationType.replace('_', ' ').toUpperCase()}
              </p>
              <p>
