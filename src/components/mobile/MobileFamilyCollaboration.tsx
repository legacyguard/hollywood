...
export const MobileFamilyCollaboration: React.FC<MobileFamilyCollaborationProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'members' | 'activity' | 'documents'>('members');
  ...
  const recentActivity = [
    { id: 1, type: 'document', user: 'Sarah Johnson', action: 'shared will document', time: '1 hour ago' },
    { id: 2, type: 'task', user: 'Mike Johnson', action: 'completed insurance review', time: '3 hours ago' },
    { id: 3, type: 'message', user: 'Emma Johnson', action: 'added comment on family calendar', time: '1 day ago' },
  ];
            ...
            {member.pendingTasks > 0 && (
              <div className="flex items-center mt-2">
                ...
                <span className="text-xs text-orange-600">
                  {member.pendingTasks} pending task{member.pendingTasks > 1 ? 's' : ''}
                </span>
              </div>
            )}
          </div>
            ...
            >
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="font-medium text-gray-900 mb-2">No shared documents yet</h3>
                  <p className="text-sm text-gray-500 mb-4">
                    Share documents with family members to collaborate on legacy planning
                  </p>
