...
type WizardStep = 'setup' | 'personal' | 'family' | 'assets' | 'beneficiaries' | 'executors' | 'review' | 'generating';
...
export const WillWizard: React.FC<WillWizardProps> = ({
  ...
  const progress = state.currentStep === 'generating' ? 100 : (currentStepIndex / (steps.length - 1)) * 100;
  ...
  const validateCurrentStep = async (): Promise<boolean> => {
    ...
    try {
      const jurisdictionConfig = await templateLibrary.getJurisdictionConfig(state.jurisdiction);
      const template = await templateLibrary.getTemplate(state.jurisdiction, state.willType, state.language);
  ...
  const nextStep = async () => {
    ...
    const stepOrder: WizardStep[] = ['setup', 'personal', 'family', 'assets', 'beneficiaries', 'executors', 'review'];
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground mb-6">
          Sofia will guide you through creating a legally compliant will for your jurisdiction.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <Select value={state.jurisdiction} onValueChange={(value: Jurisdiction) => updateState({ jurisdiction: value })}>
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <div>
          ...
          <Select value={state.language} onValueChange={(value: LanguageCode) => updateState({ language: value })}>
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="md:col-span-2">
          ...
          <Select value={state.willType} onValueChange={(value: WillTemplateType) => updateState({ willType: value })}>
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Holographic wills are recommended for most situations in CZ/SK as they don't require witnesses.
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) => updateUserData({
              personal: { ...state.userData.personal, fullName: e.target.value }
            })}
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => updateUserData({
              personal: { ...state.userData.personal, dateOfBirth: e.target.value }
            })}
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => updateUserData({
              personal: { ...state.userData.personal, placeOfBirth: e.target.value }
            })}
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => updateUserData({
              personal: { ...state.userData.personal, citizenship: e.target.value }
            })}
        ...
        <div className="md:col-span-2">
          ...
          <Select
            ...
            onValueChange={(value) => updateUserData({
              personal: { ...state.userData.personal, maritalStatus: value as any }
            })}
          >
            <SelectTrigger>
              <SelectValue />
          ...
          <Input
            ...
            onChange={(e) => updateUserData({
              personal: {
                ...
                address: { ...state.userData.personal.address, street: e.target.value }
              }
            })}
          />
          <Input
            ...
            onChange={(e) => updateUserData({
              personal: {
                ...state.userData.personal,
                address: { ...state.userData.personal.address, city: e.target.value }
              }
            })}
          />
          <Input
            ...
            onChange={(e) => updateUserData({
              personal: {
                ...state.userData.personal,
                address: { ...state.userData.personal.address, postalCode: e.target.value }
              }
            })}
          />
          <Input
            ...
            onChange={(e) => updateUserData({
              personal: {
                ...state.userData.personal,
                address: { ...state.userData.personal.address, country: e.target.value }
              }
            })}
          />
        </div>
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-2">
          Add information about your children (this affects inheritance laws in CZ/SK)
        </p>
          ...
          <div key={index} className="border p-3 rounded-md mb-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
              ...
              <Input
                ...
                onChange={(e) => {
                  const children = [...(state.userData.family.children || [])];
                  children[index] = { ...children[index], dateOfBirth: e.target.value };
                  updateUserData({
                    family: { ...state.userData.family, children }
                  });
                }}
    ...
    <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    const beneficiaries = [...state.userData.beneficiaries];
                    beneficiaries[index] = { ...beneficiaries[index], name: e.target.value };
                    updateUserData({ beneficiaries });
                  }}
                />
              </div>
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    const beneficiaries = [...state.userData.beneficiaries];
                    beneficiaries[index] = { ...beneficiaries[index], relationship: value };
                    updateUserData({ beneficiaries });
                  }}
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    beneficiaries[index] = {
                      ...beneficiaries[index],
                      share: { ...beneficiaries[index].share, value: Number(e.target.value) }
                    };
                    updateUserData({ beneficiaries });
                  }}
                />
      ...
      {state.userData.beneficiaries.length === 0 && (
        <Alert>
          ...
          <AlertDescription>
            You must specify at least one beneficiary. Sofia can suggest fair distribution based on your family situation.
          </AlertDescription>
        </Alert>
      )}
    </div>
  ...
  const renderExecutorsStep = () => (
    <div className="space-y-4">
      ...
      <p className="text-muted-foreground">
        Executors will carry out your will's instructions. Choose trusted people.
      </p>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    executors[index] = { ...executors[index], name: e.target.value };
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    executors[index] = {
                      ...executors[index],
                      contactInfo: { ...executors[index].contactInfo, email: e.target.value }
                    };
                    updateUserData({ executors });
                  }}
                />
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            <p><strong>Name:</strong> {state.userData.personal.fullName}</p>
            <p><strong>Status:</strong> {state.userData.personal.maritalStatus}</p>
            <p><strong>Citizenship:</strong> {state.userData.personal.citizenship}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p><strong>Jurisdiction:</strong> {state.jurisdiction}</p>
            <p><strong>Type:</strong> {state.willType}</p>
          ...
          <CardContent>
            {state.userData.beneficiaries.map((beneficiary, index) => (
              <div key={index} className="flex justify-between items-center py-1">
                <span>{beneficiary.name} ({beneficiary.relationship})</span>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Create your will with Sofia's AI assistance</p>
      </div>
        ...
        <div className="flex justify-between">
          ...
          <div className="space-x-2">
            ...
            {state.currentStep === 'review' ? (
              ...
              >
                {state.isLoading && <Loader2 className="h-4 w-4 animate-spin mr-2" />}
                Generate Will
              </Button>
            ) : (
              <Button
