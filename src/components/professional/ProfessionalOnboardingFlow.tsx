...
interface ProfessionalOnboardingFlowProps {
  onComplete: (data: Omit<ProfessionalOnboarding, 'id' | 'status' | 'created_at' | 'updated_at'>) => void;
  onCancel?: () => void;
  className?: string;
}
...
const SPECIALIZATIONS = [
  { id: 'estate_planning', name: 'Estate Planning', category: 'estate_planning' },
  ...
  { id: 'guardianship', name: 'Guardianship & Conservatorship', category: 'family_law' },
  { id: 'asset_protection', name: 'Asset Protection', category: 'estate_planning' }
];
...
export function ProfessionalOnboardingFlow({
  ...
  const isStepValid = (step: number): boolean => {
    switch (step) {
      case 1:
        return !!(formData.email && formData.full_name && formData.professional_title);
      case 2:
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateFormData({ law_firm_name: e.target.value })}
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateFormData({ hourly_rate: e.target.value ? parseInt(e.target.value) : undefined })}
                  placeholder="250"
                  className="mt-1"
                />
                <p className="text-sm text-gray-600 mt-1">
    ...
    <div className={cn('max-w-4xl mx-auto', className)}>
      ...
      <div className="text-center mb-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-gray-900">Join Our Professional Network</h1>
        </motion.div>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Help families protect their legacy while building your practice. Join a network of trusted legal professionals.
        </p>
      </div>
