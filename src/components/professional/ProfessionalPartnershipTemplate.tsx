    ...
    <div className={cn('max-w-4xl mx-auto', className)}>
      ...
      <div className="text-center mb-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-gray-900">Professional Partnership Agreement</h1>
        </motion.div>
          ...
          >
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-gray-900 mb-1">{term.value}</div>
                <div className="font-medium text-gray-700 mb-1">{term.label}</div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="prose max-w-none text-gray-700">
                  ...
                  <h4 className="text-lg font-semibold mt-6 mb-3">Service Categories</h4>
                  <ul className="list-disc ml-6 space-y-2">
                    <li><strong>Basic Review:</strong> Essential legal compliance and formatting review</li>
                    <li><strong>Comprehensive Review:</strong> Detailed analysis with recommendations</li>
                    <li><strong>Certified Review:</strong> Attorney-certified review with legal opinions</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <TabsContent value="compensation" className="p-6">
            <div className="space-y-6">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">{terms.commission_rate}%</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Minimum Fee:</span>
                        <span className="font-semibold">{formatCurrency(terms.minimum_fee)}</span>
                      </div>
                      <Separator />
                      <div className="text-sm text-green-700">
                        <p><strong>Example:</strong> For a $500 review, you earn ${500 * (terms.commission_rate / 100)}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">Every {terms.payment_terms} days</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="text-sm text-blue-700">
                        <p>Payments processed automatically after review completion</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-2">Additional Compensation Opportunities</h4>
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Bonus payments for exceptional client satisfaction scores</li>
                  <li>• Higher commission rates after 50+ successful reviews</li>
                  <li>• Priority assignment for preferred review types</li>
                  <li>• Referral bonuses for bringing new professional reviewers</li>
                </ul>
              </div>
            </div>
          </TabsContent>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      Maintain {terms.review_quality_sla}% minimum client satisfaction rating
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="font-medium">•</span>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg text-sm">
                    <ul className="space-y-2">
                      <li>• This agreement remains in effect until terminated by either party</li>
                      <li>• Either party may terminate with {terms.termination_notice} days written notice</li>
                      <li>• LegacyGuard may terminate immediately for breach of quality standards</li>
                      <li>• All pending reviews must be completed before termination takes effect</li>
                    </ul>
                  </div>
                </div>

                <div>
                  <h4 className="font-semibold mb-3">Confidentiality and Data Protection</h4>
                  <div className="bg-gray-50 p-4 rounded-lg text-sm">
                    <ul className="space-y-2">
                      <li>• All client documents and information are strictly confidential</li>
                      <li>• Professional must use secure, encrypted systems for document access</li>
                      <li>• Confidentiality obligations survive for {terms.confidentiality_period} years after termination</li>
                      <li>• Professional may not retain copies of client documents</li>
                    </ul>
                  </div>
                </div>

                <div>
                  <h4 className="font-semibold mb-3">Liability and Insurance</h4>
                  <div className="bg-gray-50 p-4 rounded-lg text-sm">
                    <ul className="space-y-2">
                      <li>• Professional maintains full responsibility for legal opinions provided</li>
                      <li>• LegacyGuard's liability is limited to {formatCurrency(terms.liability_limit)} per incident</li>
                      <li>• Professional must maintain professional liability insurance</li>
                      <li>• Each party indemnifies the other for their respective actions</li>
                    </ul>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg text-sm">
                    <ul className="space-y-2">
                      <li>• Professional retains rights to their legal analysis and opinions</li>
                      <li>• LegacyGuard retains rights to platform technology and processes</li>
                      <li>• Review templates may be shared with client permission</li>
