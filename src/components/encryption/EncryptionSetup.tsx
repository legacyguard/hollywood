...
import { Shield, Lock, Key, AlertCircle, CheckCircle, Eye, EyeOff, Info } from 'lucide-react';
      ...
      <Card className="max-w-2xl mx-auto">
        ...
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              <strong>Important:</strong> Remember your encryption password. It cannot be recovered if lost.
    ...
    <Card className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-medium">Your encryption password is never sent to our servers</p>
                    <p className="text-sm text-muted-foreground">
                      We use client-side encryption to ensure only you can access your documents
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-medium">This password cannot be recovered</p>
                    <p className="text-sm text-muted-foreground">
                      If you forget your password, you will lose access to your encrypted documents
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      We use NaCl (Networking and Cryptography library) for secure encryption
                    </p>
                  </div>
                </div>
              </div>
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Tip:</strong> Use a password manager to generate and store a strong, unique password for your encryption.
                </AlertDescription>
              </Alert>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="acknowledge" className="text-sm">
                  I understand that my encryption password cannot be recovered if lost
                </Label>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <Alert>
                ...
                <AlertDescription>
                  Choose a password you\'ll remember. It should be different from your login password.
                </AlertDescription>
              </Alert>
            </div>
          </div>
      ...
      <CardFooter className="flex justify-between">
        ...
        <div className={cn(step === 1 && 'ml-auto')}>
          {step < 3 ? (
            <Button onClick={handleNext} disabled={isLoading || (step === 1 && !agreed)}>
              Next
            </Button>
          ) : (
            <Button 
