...
interface LegacyStory {
  ...
  title: string;
  description: string;
  category: 'life-events' | 'family-traditions' | 'wisdom' | 'memories' | 'achievements' | 'values';
...
const storyTemplates: StoryTemplate[] = [
  ...
  },
  {
    ...
    suggestedContent: ['video messages', 'written reflections', 'audio recordings'],
  ...
  },
  {
    ...
    suggestedContent: ['recipe cards', 'celebration photos', 'tradition videos'],
...
export const LegacyStoryCreation: React.FC<LegacyStoryCreationProps> = ({
  ...
  const calculateDuration = (contents: StoryContent[]): number => {
    return contents.reduce((total, content) => {
      if (content.type === 'text') return total + Math.ceil(content.content.toString().length / 200);
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      case 'memories': return <Heart className="h-4 w-4" />;
      case 'wisdom': return <BookOpen className="h-4 w-4" />;
      case 'family-traditions': return <Users className="h-4 w-4" />;
      case 'achievements': return <Star className="h-4 w-4" />;
      case 'life-events': return <Calendar className="h-4 w-4" />;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Legacy Story Creation</h2>
          <p className="text-gray-600">Create meaningful stories to preserve your family's legacy</p>
        </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setActiveStory({...activeStory, description: e.target.value})}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-red-700 font-medium">
                          Recording {recordingType}... ({Math.floor(recordingProgress)}s)
                        </span>
                      </div>
                      <Button
                        size="sm"
      ...
      {stories.length === 0 && !isCreating && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">Create your first legacy story to preserve your family's memories</p>
          <Button onClick={() => setIsCreating(true)} className="gap-2">
            <Plus className="h-4 w-4" />
