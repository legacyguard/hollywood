  ...
  const getRecommendations = () => {
    ...
    if (!insights.executorAssigned) {
      recommendations.push({
        type: 'critical',
        icon: Crown,
        message: 'No executor assigned - your estate cannot be properly managed without one',
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <Badge variant={insights.executorAssigned ? "default" : "destructive"}>
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            <div>
              <div className="text-lg font-semibold text-green-600">
                {insights.totalMembers - insights.missingRoles - insights.partiallyConfigured}
              </div>
        ...
        {insights.completionRate === 100 && (
          <Alert variant="default" className="border-green-200 bg-green-50">
            ...
            <AlertDescription className="text-green-800">
              Congratulations! Your family estate plan is complete. All family members have been assigned appropriate roles.
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
