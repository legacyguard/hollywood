...
import { X, Sparkles, Users, Shield, Crown, Calendar, TrendingUp } from 'lucide-react';
      ...
      <DialogContent className={cn(
        ...
        <div className="relative">
              ...
              <div className="absolute inset-0 pointer-events-none z-50">
                {Array.from({ length: 20 }).map((_, i) => (
                  <motion.div
                    ...
                    style={{  backgroundColor: ['#fbbf24', '#f59e0b', '#d97706', '#92400e'][Math.floor(Math.random() * 4)]
                     }}
                  />
                ))}
              </div>
          ...
          <motion.div
            ...
            animate={{  scale: animationPhase === 'celebrate' ? [1, 1.05, 1] : 1,
              opacity: 1
             }}
          ...
          >
            ...
            <motion.div
              ...
              animate={{  rotate: animationPhase === 'celebrate' ? [0, 5, -5, 0] : 0,
                scale: animationPhase === 'celebrate' ? [1, 1.1, 1] : 1
               }}
              transition={{  duration: 0.8, repeat: animationPhase === 'celebrate' ? 2 : 0  }}
            >
              <div className={cn(
            ...
            <motion.div
              ...
              animate={{  scale: animationPhase === 'celebrate' ? [1, 1.2, 1] : 1,
            ...
            <Badge
              ...
              className={cn(
                ...
                milestone.badge_data.rarity === 'epic' && 'border-purple-300 text-purple-700 bg-purple-50',
                milestone.badge_data.rarity === 'rare' && 'border-blue-300 text-blue-700 bg-blue-50',
                milestone.badge_data.rarity === 'common' && 'border-gray-300 text-gray-700 bg-gray-50'
              )}
            >
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              <span className="text-sm text-gray-600">Family Benefit Score:</span>
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            {milestone.celebration_data.animation === 'garden_bloom' && (
              <motion.div
                ...
                animate={{  scale: animationPhase === 'celebrate' ? [0, 1.2, 1] : 1,
