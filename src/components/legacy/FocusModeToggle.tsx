...
export const FocusModeToggle: React.FC<FocusModeToggleProps> = ({
  ...
  const ToggleButton = () => (
    ...
    >
      <Icon name="maximize-2" className="w-4 h-4 mr-2 group-hover:text-primary" />
      <span className="font-medium">Enter Focus Mode</span>
      <Icon name="sparkles" className="w-3 h-3 ml-2 opacity-60 group-hover:opacity-100 group-hover:text-primary" />
    </Button>
  );
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-sm text-blue-700 dark:text-blue-300">
              Hide distractions and create your will in a calm, dedicated environment.
            </p>
          </div>
          <div className="ml-4">
            <ToggleButton />
