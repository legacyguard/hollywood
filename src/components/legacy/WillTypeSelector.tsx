...
export const WillTypeSelector: React.FC<WillTypeSelectorProps> = ({
  ...
  const [showDetails, setShowDetails] = useState<WillType | null>(null);
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <Icon name="loader" className="w-8 h-8 text-primary animate-spin mx-auto mb-4" />
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <FadeIn duration={0.6}>
          <div className="text-center mb-12">
            <Icon name="document-text" className="w-12 h-12 text-primary mx-auto mb-6" />
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-8">
            ...
            <FadeIn duration={0.5} delay={0.2}>
              <Card className={`p-6 cursor-pointer transition-all hover:shadow-lg ${
                selectedType === 'holographic' ? 'border-primary bg-primary/5 shadow-lg' : 'hover:border-primary/50'
              }`}>
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold mb-2">{holographic.name}</h3>
                    <Badge variant="outline" className="text-xs">
                      {holographic.legalBasis}
                    </Badge>
                  </div>
                  <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                    selectedType === 'holographic' ? 'border-primary bg-primary' : 'border-muted-foreground'
                  }`}>
                ...
                <p className="text-muted-foreground mb-4">{holographic.description}</p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      {holographic.advantages.slice(0, 2).map((advantage, idx) => (
            ...
            <FadeIn duration={0.5} delay={0.4}>
              <Card className={`p-6 cursor-pointer transition-all hover:shadow-lg ${
                selectedType === 'witnessed' ? 'border-primary bg-primary/5 shadow-lg' : 'hover:border-primary/50'
              }`}>
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold mb-2">{witnessed.name}</h3>
                    <Badge variant="outline" className="text-xs">
                      {witnessed.legalBasis}
                    </Badge>
                  </div>
                  <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                    selectedType === 'witnessed' ? 'border-primary bg-primary' : 'border-muted-foreground'
                  }`}>
                ...
                <p className="text-muted-foreground mb-4">{witnessed.description}</p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      {witnessed.advantages.slice(0, 2).map((advantage, idx) => (
                        <li key={idx} className="flex items-start gap-2">
                          <span className="text-green-600 mt-1">•</span>
                          {advantage}
                        </li>
              ...
              <Card className="p-6 bg-muted/30">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold">
                    Detailed Information: {legalInfo.willTypes[showDetails].name}
                  </h3>
                  <Button
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <ul className="text-sm space-y-2">
                      {legalInfo.willTypes[showDetails].requirements.map((req, idx) => (
                        <li key={idx} className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <ul className="text-sm space-y-2">
                      {legalInfo.willTypes[showDetails].advantages.map((advantage, idx) => (
                        <li key={idx} className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <ul className="text-sm space-y-2">
                      {legalInfo.willTypes[showDetails].disadvantages.map((disadvantage, idx) => (
                        <li key={idx} className="flex items-start gap-2">
          ...
          <div className="flex justify-between mt-8">
            ...
            >
              Continue with {selectedType ? legalInfo.willTypes[selectedType].name : 'Selected Type'}
