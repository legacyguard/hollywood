...
import { formatDate, formatRelativeTime, formatCurrency, formatFileSize } from '@/lib/i18n/enhanced-config';
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold">{t('plurals.title', 'Plural Examples')}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 border rounded-lg">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-mono w-12 text-center">{documentCount}</span>
              <button 
            ...
            <p className="text-sm text-gray-600 mt-1">
              {t('dashboard.metrics.documentsProtectedCount', { count: documentCount })}
            </p>
          </div>
          ...
          <div className="p-4 border rounded-lg">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-mono w-12 text-center">{guardianCount}</span>
              <button 
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold">{t('dateFormatting.title', 'Date Formatting')}</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">{t('dateFormatting.standard', 'Standard Date')}</h3>
            <p>{t('common.date', { date: createdDate })}</p>
          </div>

          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">{t('dateFormatting.short', 'Short Date')}</h3>
            <p>{t('common.dateShort', { date: createdDate })}</p>
          </div>

          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">{t('dateFormatting.long', 'Long Date')}</h3>
            <p>{t('common.dateLong', { date: createdDate })}</p>
          </div>

          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">{t('dateFormatting.relative', 'Relative Date')}</h3>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold">{t('numberFormatting.title', 'Number Formatting')}</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">{t('numberFormatting.fileSize', 'File Size')}</h3>
          ...
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">{t('numberFormatting.currency', 'Currency')}</h3>
          ...
          <div className="p-4 border rounded-lg">
            <h3 className="font-semibold mb-2">{t('numberFormatting.percentage', 'Percentage')}</h3>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold">{t('fallback.title', 'Fallback Mechanism')}</h2>
        ...
        <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li>
              {t('fallback.point1', 'If a translation is missing in Slovak, English will be shown')}
            </li>
            <li>
              {t('fallback.point2', 'This ensures the app never shows technical keys to users')}
            </li>
            <li>
              {t('fallback.point3', 'Missing translations are logged in development mode')}
            </li>
          </ul>
        </div>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold">{t('realWorld.title', 'Real-World Example')}</h2>
        ...
        <div className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white p-3 rounded shadow">
              <p className="text-sm text-gray-600">{t('dashboard.metrics.documentsProtected')}</p>
            ...
            <div className="bg-white p-3 rounded shadow">
              <p className="text-sm text-gray-600">{t('dashboard.metrics.guardians')}</p>
              <p className="text-2xl font-bold">{guardianCount}</p>
              <p className="text-xs text-gray-500">
                {t('dashboard.metrics.guardiansCount', { count: guardianCount })}
              </p>
            </div>
            
            <div className="bg-white p-3 rounded shadow">
              <p className="text-sm text-gray-600">{t('dashboard.metrics.daysProtected')}</p>
            ...
            <div className="bg-white p-3 rounded shadow">
              <p className="text-sm text-gray-600">{t('settings.storage.title', 'Storage')}</p>
