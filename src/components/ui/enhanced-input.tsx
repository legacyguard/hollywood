    ...
    return (
      ...
      >
        ...
        <div className="relative">
          <MicroAnimation
            type={animateOnError && error ? "error-shake" : getPersonalityAnimation()}
            ...
            >
              ...
              <AnimatePresence>
                {leftIcon && (
                  ...
                  >
                    <Icon name={leftIcon} className="w-4 h-4 text-muted-foreground" />
                  </motion.div>
                )}
              </AnimatePresence>
                ...
                <AnimatePresence mode="wait">
                  ...
                  {rightIcon && !getCurrentStateIcon() && (
                    <motion.div
                      ...
                      transition={{ duration: 0.2 }}
                    >
                      <Icon name={rightIcon} className="w-4 h-4 text-muted-foreground" />
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
