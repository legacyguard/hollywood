  ...
  "rounded-xl border bg-card text-card-foreground shadow transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        empathetic: "border-pink-200 bg-gradient-to-br from-pink-50 to-purple-50",
...
const EnhancedCard = React.forwardRef<HTMLDivElement, EnhancedCardProps>(
  ({
    ...
    const interactiveLevel = isInteractive ? 'clickable' : (hoverEffect ? 'hover' : 'none')
                  ...
                  >
                    {image ? (
                      ...
                      <div className={cn(
                        ...
                        personalityAdapt && {
                          'bg-pink-100 text-pink-600': personality.mode === 'empathetic',
                          'bg-gray-100 text-gray-600': personality.mode === 'pragmatic',
                          'bg-blue-100 text-blue-600': personality.mode === 'adaptive'
                        }
                      )}>
