...
export function RecipientStep({ guardians, selectedRecipient, onRecipientChange }: RecipientStepProps) {
          ...
          <CardContent className="space-y-3">
            <div className="grid gap-3">
              {guardianOptions.map((guardian) => (
                <button
                  key={guardian.id}
                  onClick={() => handleGuardianSelect(guardians.find(g => g.id === guardian.id)!)}
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                This email will be used to notify them when the Time Capsule is delivered.
              </p>
            </div>
            ...
            <div className="flex gap-2 pt-2">
              <Button
                ...
                disabled={!customRecipient.name.trim() || !customRecipient.email.trim()}
                className="flex-1"
              >
              ...
              <Button
                variant="outline"
                onClick={handleCustomRecipientCancel}
              >
                Cancel
              </Button>
            </div>
