...
export function ImportCelebration({ result, onContinue, className }: ImportCelebrationProps) {
          ...
          >
            ...
            >
              <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-blue-600 mb-1">{documents.length}</div>
                <div className="text-xs text-muted-foreground">Documents</div>
                <div className="text-xs text-muted-foreground">Protected</div>
              </div>
              <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-purple-600 mb-1">{timeSaved}min</div>
                <div className="text-xs text-muted-foreground">Time</div>
                <div className="text-xs text-muted-foreground">Saved</div>
              </div>
              <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600 mb-1">+{protectionIncrease}%</div>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 text-left">
                  <h4 className="font-medium text-blue-900 mb-1">Family Impact</h4>
                  <p className="text-sm text-blue-800">{getFamilyImpactStatement()}</p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-sm text-purple-800">
                    Consider sharing key documents with family members and scheduling professional reviews for maximum protection.
                  </p>
                </div>
              </div>
            </motion.div>
