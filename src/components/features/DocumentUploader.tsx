  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    if (files && files[0]) {
      ...
      if (!validTypes.includes(fileExtension)) {
        toast.error('Please select a valid file type (PDF, DOC, DOCX, JPG, PNG, or TXT)');
        return;
      }
          ...
          >
            ...
            <div className="text-center space-y-4">
              <motion.div
                ...
                whileHover={{ scale: 1.1, backgroundColor: "rgb(var(--primary) / 0.15)" }}
                transition={{ duration: 0.2 }}
              >
              ...
              <div>
                <p className="text-lg font-medium mb-2">Choose a file or drag & drop</p>
            ...
            {file && !isUploading && (
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                >
                  <Icon name="x" className="w-3 h-3 text-muted-foreground hover:text-red-500" />
                </motion.button>
              </motion.div>
            )}
          </AnimatePresence>
