...
import { TrendingUp, Users, Clock, Shield, Sparkles, ChevronRight } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { cn } from '@/lib/utils';
import { generateQuickInsights, formatInsightValue, type QuickInsight } from '@/lib/quick-insights';
...
export function QuickInsightsPanel({
  ...
  }, [documents, willData, familyMembersCount, emergencyContactsCount, isFirstDocument, celebrationShown]);
  ...
  const secondaryInsights = insights.filter(i => i.impact === 'medium' || i.impact === 'low').slice(0, 3);
  ...
  return (
    <div className={cn('space-y-4', className)}>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-emerald-700">You've taken the first step in protecting your family's future.</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <Card key={insight.id} className="hover:shadow-md transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-start gap-3">
                  <div className={cn('p-2 rounded-lg', getInsightColor(insight.impact))}>
              ...
              <CardContent className="pt-0">
                <div className="space-y-3">
                  ...
                  {insight.action_suggestion && (
                    <Button
                      size="sm"
                      variant={insight.action_suggestion.urgent ? "default" : "outline"}
      ...
      {secondaryInsights.length > 0 && (
        <div className="space-y-3">
          <h4 className="text-sm font-medium text-muted-foreground">Additional Insights</h4>
              ...
              return (
                <Card key={insight.id} className="p-4">
                  <div className="flex items-center gap-3">
                    <div className={cn('p-1.5 rounded', getInsightColor(insight.impact))}>
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
        <CardContent className="p-4">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-lg font-bold text-blue-800">{documents.length}</div>
