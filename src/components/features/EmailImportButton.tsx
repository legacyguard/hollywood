            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Automatically find and organize important documents from your email attachments
                </p>
              </div>
            </div>
...
function EmailImportDialog({ isOpen, onClose, onImportComplete }: EmailImportDialogProps) {
  return (
