      ...
      <Card className="p-8 bg-card border-card-border">
        <div className="space-y-6">
              ...
              <div className="text-sm space-y-2">
                ...
                <ul className="space-y-1 text-blue-800 dark:text-blue-200">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Backups contain sensitive data. Store them securely and never share them publicly.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span>Regular backups are recommended, especially before major changes.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span>Imported data will be merged with existing data to avoid duplicates.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="border-t border-card-border pt-6">
            <h3 className="text-lg font-semibold mb-4 text-status-error">Danger Zone</h3>
            <div className="p-4 border-2 border-status-error/20 rounded-lg bg-status-error/5">
              <div className="flex items-start gap-4">
                <Icon name="triangle-exclamation" className="w-6 h-6 text-status-error flex-shrink-0 mt-1" />
                <div className="flex-1">
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle className="flex items-center gap-2">
                <Icon name="triangle-exclamation" className="w-5 h-5 text-status-error" />
                Clear All Data?
              </AlertDialogTitle>
