    ...
    <div className={`space-y-6 ${className}`}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Experience the enhanced document upload with Sofia's magical assistance
          </CardDescription>
        </CardHeader>
        <CardContent>
          {/* Controls */}
          <div className="space-y-4 mb-6">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <Button onClick={startMagicalAnalysis} variant="outline" size="sm">
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Experience Sofia's welcoming firefly and document analysis
                      </p>
                    </div>
                  </div>
                </MagicalDropZone>
          ...
          <div className="mt-4 text-sm text-gray-500 space-y-2">
            <p><strong>Test the Magic:</strong></p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li>Drag any file over the upload area to see Sofia's firefly welcome</li>
              <li>Drop a file to trigger the magical document analysis animation</li>
              ...
              <li>See how Sofia guides the analysis with different personality styles</li>
            </ul>
            <p className="mt-4">
