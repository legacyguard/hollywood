  ...
  const smartInsights: SmartInsight[] = [
    {
      ...
      message: 'Your family lacks critical healthcare decision-making documents. This could cause delays in emergency situations.',
    ...
    },
    {
      ...
      message: 'You\'re 3 days away from achieving a 10-day completion streak. One quick task today will keep you on track.',
    ...
    },
    {
      ...
      message: 'Based on your progress, now would be a good time to invite family members to review and discuss your legacy plan.',
    ...
    },
    {
      ...
      message: 'Congratulations! You\'ve completed 65% of your legacy planning journey. Your family is significantly more protected.',
      confidence: 100,
      category: 'progress',
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-yellow-600">{metrics.timeInvested}</div>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-indigo-600">{metrics.familyMembers}</div>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-teal-600">{metrics.documentsSecured}</div>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="text-sm font-medium text-green-600">+28%</div>
                      <TrendingUp className="h-3 w-3 text-green-600" />
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-medium">Healthcare Proxy completed</div>
                  ...
                  <div className="flex items-center gap-3">
                    <Clock className="h-4 w-4 text-yellow-600" />
                    <div className="flex-1">
                      <div className="text-sm font-medium">Asset inventory started</div>
