...
export default function InsightsDashboard({ className }: InsightsDashboardProps) {
  ...
  const categoryChartData = Object.entries(dashboardData.overview.categoryDistribution).map(([name, value]) => ({
    name: name.charAt(0).toUpperCase() + name.slice(1),
    value,
    fill: CHART_COLORS[Object.keys(dashboardData.overview.categoryDistribution).indexOf(name) % CHART_COLORS.length]
  }));
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Document Insights</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatNumber(dashboardData.overview.totalDocuments)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatBytes(dashboardData.overview.totalSize)}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className={cn('text-2xl font-bold', getHealthColor(dashboardData.security.complianceScore))}>
        ...
        <Card>
          ...
          <CardContent>
            <div className={cn('text-2xl font-bold', getHealthColor(dashboardData.health.healthScore))}>
        ...
        <TabsContent value="overview" className="space-y-6">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={storageGrowthData}>
                    ...
                    <Area type="monotone" dataKey="sizeGB" stroke="#8884d8" fill="#8884d8" fillOpacity={0.3} />
                  </AreaChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Priority actions to improve your document management</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={index} className="flex items-start space-x-3 p-4 border rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground mt-2">
                        Est. time: {rec.estimatedTime} • {rec.documentIds.length} documents affected
                      </p>
                    </div>
                  </div>
                ))}
        ...
        <TabsContent value="security" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Documents contain PII</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Need password protection</p>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Actions to improve your document security posture</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="usage" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>When you're most active with document management</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {dashboardData.usage.frequentlyAccessedCategories.map((category) => (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your document management behavior patterns</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {dashboardData.usage.userBehavior.averageSessionDuration} min
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Documents per Session</span>
                    <span className="font-medium">
                      {dashboardData.usage.userBehavior.documentsPerSession}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Searches per Session</span>
                    <span className="font-medium">
                  ...
                  <Separator />
                  <div>
                    <h4 className="text-sm font-medium mb-2">Most Common Actions</h4>
                    <div className="flex flex-wrap gap-2">
                      {dashboardData.usage.userBehavior.mostCommonActions.map((action) => (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Document upload patterns over time</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={dashboardData.usage.uploadTrends.daily.map((count, index) => ({
                  day: `Day ${index + 1}`,
                  uploads: count
                }))}>
                  <CartesianGrid strokeDasharray="3 3" />
        ...
        <TabsContent value="health" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Overall health of your document collection</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center">
                  <div className={cn('text-4xl font-bold mb-2', getHealthColor(dashboardData.health.healthScore))}>
                    {dashboardData.health.healthScore}%
                  </div>
                  <Progress value={dashboardData.health.healthScore} className="w-full" />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Breakdown of health issues found</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-sm">Total Issues</span>
                    <span className="font-medium">{dashboardData.health.issues.length}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm">Duplicates</span>
                    <span className="font-medium">{dashboardData.health.duplicates.length}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm">Large Files</span>
                    <span className="font-medium">{dashboardData.health.largeSizeWarnings.length}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm">Old Documents</span>
                    <span className="font-medium">{dashboardData.health.oldDocuments.length}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Specific issues that need attention</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {dashboardData.health.issues.slice(0, 10).map((issue) => (
                  <div key={issue.id} className="flex items-start space-x-3 p-3 border rounded-lg">
                    <AlertCircle className={cn('h-4 w-4 mt-0.5', {
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">{issue.resolution}</p>
                      {issue.autoFixable && (
        ...
        <TabsContent value="trends" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>How different document categories are trending</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Security score and issues over time</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={dashboardData.trends.securityTrends}>
                  ...
                  <Line type="monotone" dataKey="issues" stroke="#FF8042" strokeWidth={2} />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Projected needs based on current trends</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Storage Needed (Next Month)</span>
                    <span className="font-medium">{dashboardData.predictions.storageNeeded} GB</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Expected Documents</span>
                    <span className="font-medium">{dashboardData.predictions.documentsExpected}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Estimated Cost</span>
                    <span className="font-medium">${dashboardData.predictions.costProjection}/mo</span>
                  </div>
                </div>
                <div>
                  <h4 className="text-sm font-medium mb-2">Maintenance Required</h4>
                  <div className="space-y-1">
                    {dashboardData.predictions.maintenanceRequired.map((item, index) => (
