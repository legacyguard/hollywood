...
export function generateFamilyImpactStatement(
  action: 'first_document' | 'will_completed' | 'family_added' | 'emergency_contact' | 'insurance_added' | 'milestone_reached',
  ...
  switch (action) {
    case 'first_document':
      return {
        primary_message: "You've placed the first stone in your family's mosaic of certainty",
        ...
        call_to_action: 'Add an emergency contact so someone can access this right away',
        celebration_message: 'This is the beginning of your family\'s security journey! 🌟',
    ...
    case 'will_completed':
      return {
        primary_message: "Your family now has the ultimate gift: clarity about your wishes",
        ...
        celebration_message: 'You\'ve given your family the most precious gift: peace of mind! 🎉',
        urgency_level: 'low',
    ...
    case 'family_added':
      return {
        ...
        emotional_hook: 'Every person you add multiplies the security net around your family',
        benefit_details: [
        ...
        call_to_action: context.familyMembersCount < 3 ? 'Consider adding one more trusted person' : undefined,
        urgency_level: 'low',
    ...
    case 'emergency_contact':
      return {
        primary_message: "Someone trusted now holds the key to help your family immediately",
        emotional_hook: 'In critical moments, your emergency contact becomes your family\'s hero',
        benefit_details: [
    ...
    case 'milestone_reached':
      return {
        ...
        urgency_level: context.protectionLevel === 'comprehensive' ? 'low' : 'medium',
    ...
    default:
      return {
        ...
        benefit_details: ['Your thoughtful preparation creates lasting peace of mind'],
        urgency_level: 'low',
 ...
 */
function getProtectionMilestoneMessage(level: FamilyContext['protectionLevel']): string {
  switch (level) {
    case 'comprehensive':
 ...
 */
function getProtectionBenefits(level: FamilyContext['protectionLevel']): string[] {
  const baseBenefits = [
 ...
 */
function getProtectionCelebration(level: FamilyContext['protectionLevel']): string {
  switch (level) {
    case 'comprehensive':
...
export function generateUrgentFamilyImpact(
  missingAction: 'will' | 'emergency_contact' | 'beneficiary' | 'insurance',
  context: FamilyContext
): FamilyImpactStatement {
  ...
  switch (missingAction) {
    case 'will':
      return {
        ...
        emotional_hook: 'Without clear instructions, your family might struggle to honor what you really wanted',
        benefit_details: [
    ...
    case 'emergency_contact':
      return {
        primary_message: 'In a crisis, every second counts - give someone the power to help immediately',
...
export function generateMilestoneCelebration(
  ...
  return celebrations[milestone] || celebrations['first_document'];
}
