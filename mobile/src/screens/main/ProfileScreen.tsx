          ...
          <Stack space="medium">
            ...
            <Stack space="small">
              <SettingItem
                ...
                value={themeMode === 'light' ? <Check size={20} color="#16a34a" /> : null}
                showArrow={false}
              />
              <SettingItem
                ...
                value={themeMode === 'dark' ? <Check size={20} color="#16a34a" /> : null}
                showArrow={false}
              />
              <SettingItem
                ...
                value={themeMode === 'system' ? <Check size={20} color="#16a34a" /> : null}
                showArrow={false}
              />
            </Stack>
          </Stack>
