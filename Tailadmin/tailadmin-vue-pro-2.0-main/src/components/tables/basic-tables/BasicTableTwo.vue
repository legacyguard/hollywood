      ...
      <table class="min-w-full">
        ...
        <thead>
          <tr class="border-y border-gray-100 bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
            ...
            <th class="px-6 py-3 text-left">
              <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Deal Value</p>
            </th>
            <th class="px-6 py-3 text-left">
              <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Close Date</p>
            </th>
            <th class="px-6 py-3 text-left">
          ...
          <tr v-for="order in orders" :key="order.id">
            ...
            <td class="px-4 py-3.5 sm:px-6">
              <div class="flex items-center gap-3">
                ...
                >
                  <span class="text-xs font-semibold" :class="order.avatarColor">
                    {{ order.initials }}
                  </span>
                </div>
                <div>
            ...
            <td class="px-4 py-3.5 sm:px-6">
              <span
                class="rounded-full inline-block px-2 py-0.5 text-theme-xs font-medium"
            ...
            <td class="px-4 py-3.5 sm:px-6">
              <svg
                ...
                class="cursor-pointer fill-gray-700 hover:fill-error-500 dark:fill-gray-400 dark:hover:fill-error-500"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
...
const orders = ref([
  ...
  },
  {
    ...
    initials: 'TG',
    avatarBg: 'bg-success-50',
    avatarColor: 'text-success-600',
    product: 'Software License',
    value: '$18,50.34',
    closeDate: '2024-06-15',
    status: 'Complete',
...
const toggleAllChecked = () => {
  ...
  orders.value.forEach((order) => (order.checked = allChecked.value))
}

const toggleChecked = (order) => {
  order.checked = !order.checked
  allChecked.value = orders.value.every((order) => order.checked)
}
