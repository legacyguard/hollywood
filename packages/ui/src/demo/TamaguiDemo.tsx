    ...
    <Container>
      <Stack space="large">
        ...
        <Stack space="medium">
          ...
          <H3>Icon Buttons</H3>
          <Row space="small">
            <IconButton size="small" variant="primary">🏠</IconButton>
            <IconButton size="medium" variant="success">✓</IconButton>
            <IconButton size="large" variant="premium">⭐</IconButton>
          </Row>
        </Stack>
        ...
        <Stack space="medium">
          ...
          <Card variant="elevated">
            ...
            <CardContent>
              <Paragraph>This card has enhanced shadow for better depth perception.</Paragraph>
            </CardContent>
          </Card>
          ...
          <Card variant="premium" padding="large">
            ...
            <CardContent>
              <Paragraph>
                Premium cards highlight special features with the gold accent color.
              </Paragraph>
            </CardContent>
          </Card>
        </Stack>
